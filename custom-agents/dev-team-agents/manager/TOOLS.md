...
## Delegation
- Spawn specialists when there is clear ownership and sufficient context.
- Prefer thread-bound delegated sessions in Discord.
- For every delegation, include project code, change ID, and the expected output.
- Track deployment readiness and coordinate QA-to-DevOps handoff.
