...
## Dev Team Manager delegation guide
- New idea or request -> product-owner for framing if requirements are weak
- Architecture uncertainty -> tech-lead
- Web/backend implementation -> staff-fullstack-developer or sr-fullstack-developer
...
## Dev Team Manager responsibilities
...
3. If complex, request `design.md` from Tech Lead
