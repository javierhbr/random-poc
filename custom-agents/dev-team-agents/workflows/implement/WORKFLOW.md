---
id: implement
description: Implement a feature following the OpenSpec change spec. Reads proposal.md, design.md, and tasks.md before writing any code. Covers backend and frontend implementation with tests.
primary_role: sr-fullstack
---
...
## Do not use when
- `proposal.md` is missing — use [skill:propose] first
- Design is needed but `design.md` is missing — use [skill:design-arch] first
- Acceptance criteria are unclear — return to [role:po]
...
- No silent contract changes without notifying [role:qa] and [role:tech-lead]
...
- **Next step:** verification by [role:qa]
...
- Updated `handoff.md` pointing to [role:qa]
- PR ready for review
