---
id: handoff
description: Create or update a handoff document when ownership of a change moves between agents. Use whenever you finish your part of a change and need to pass it to the next person.
...
|---------|--------------|---------|
| [role:po] | Proposal written | [role:manager] |
| [role:manager] | Tasks planned | First task owner |
| [role:tech-lead] | Design written | [role:manager] or impl owner |
| [role:sr-fullstack] | Implementation done | [role:qa] |
| [role:staff-fullstack] | Architecture approved | [role:sr-fullstack] |
| [role:mobile] | Flutter changes done | [role:qa] |
| [role:qa] | Verification passed | [role:devops] |
| [role:devops] | Deployed to production | [role:manager] (close loop) |
