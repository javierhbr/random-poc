---
id: deploy-gcp
description: Deploy a verified change to GCP via Terraform and CI/CD. Requires QA signoff in handoff.md before proceeding. Covers Cloud Run, Cloud Functions, and infrastructure changes.
primary_role: devops
---
