---
name: review-code
description: Conduct a structured code review covering correctness, security, performance, architecture alignment, and test coverage. Use when a PR is ready for review before merge. Invoke with /review-code.
---
